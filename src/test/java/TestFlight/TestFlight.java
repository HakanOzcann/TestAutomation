...
public class TestFlight
{
    ...
    {
        driver.findElement(By.cssSelector("input#OriginInput")).sendKeys("İzmir");
    ...
    {
        driver.findElement(By.cssSelector("input#DestinationInput")).sendKeys("Antalya");
        Actions pressEnterKey = new Actions(driver);
    ...
    {
        driver.findElement(By.cssSelector("input#contact_email")).sendKeys("hakan.ozcan44@hotmail.com");
        driver.findElement(By.cssSelector("input#contact_cellphone")).sendKeys("123456");
    }
    ...
    {
        ((JavascriptExecutor) driver).executeScript("scroll(0, 200);");
        driver.findElement(By.cssSelector("input#firstName_0")).sendKeys("Hakan");
        driver.findElement(By.cssSelector("input#lastName_0")).sendKeys("Özcan");
    }
    ...
    {
        driver.findElement(By.cssSelector("input#publicId_0")).sendKeys("11111111111");
    }
